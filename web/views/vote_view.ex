defmodule News.VoteView do
  ...
  def vote_form_for(model, conn, display \\ "flex") do
    ...
    vote = %News.Vote{votable_type: type, votable_id: id, return_to: rt}
    changeset = News.Vote.changeset(vote)
